...
add "app-feel"             "node app-feel.mjs"
add "reorder-everywhere"   "node reorder-everywhere.mjs"
add "reorder-physics"      "node reorder-physics.mjs"
add "left-and-right"       "node left-and-right.mjs"
add "keypad-stable"       "node keypad-stable.mjs"
add "body-hidden-view"    "node body-hidden-view.mjs"
add "onboarding-handoff"  "node onboarding-handoff.mjs"
add "quick-workout"        "node quick-workout.mjs"
add "pounds-history"       "node pounds-history.mjs"
add "gestures2"            "node gestures2.mjs"
add "spoken-portions"      "node spoken-portions.mjs"
add "say-it-log"           "node say-it-log.mjs"
add "barcode-decode"       "node barcode-decode.mjs"
add "scan-camera"          "node scan-camera.mjs"
add "no-dev-controls"      "node no-dev-controls.mjs"
add "body-reach"           "node body-reach.mjs"
add "muscle-split"         "node muscle-split.mjs"
add "catalogue-curation"   "node catalogue-curation.mjs"
add "one-search"           "node one-search.mjs"
add "portion-dial"         "node portion-dial.mjs"
add "generic-names"       "node generic-names.mjs"
add "server-reason"       "node server-reason.mjs"
add "meal-basis-persist"  "node meal-basis-persist.mjs"
add "meal-edit"            "node meal-edit.mjs"
add "keyboard-lift"        "node keyboard-lift.mjs"
add "no-zoom"              "node no-zoom.mjs"
add "voice"                 "node voice.mjs"
add "keyboard"              "node keyboard.mjs"
add "accounts"              "node v6-accounts.mjs"
add "cloud-contract"        "node cloud-contract.mjs"
add "session-refresh"      "node session-refresh.mjs"
add "account-identity"     "node account-identity.mjs"
add "coach-brief"          "node coach-brief.mjs"
add "coach-flight"         "node coach-flight.mjs"
add "coach-vocab"          "node coach-vocab.mjs"
add "weigh-in-tenths"      "node weigh-in-tenths.mjs"
add "body-zoom"            "node body-zoom.mjs"
add "muscle-week"          "node muscle-week.mjs"
add "split-writeback"      "node split-writeback.mjs"
add "split-prescription"   "node split-prescription.mjs"
add "pick-body"            "node pick-body.mjs"
add "addex-body"           "node addex-body.mjs"
add "input-feel"           "node input-feel.mjs"
add "fuel-plan"            "node fuel-plan.mjs"
