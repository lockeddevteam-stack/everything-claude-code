...
(function (g) {
  ...
  /* SPOKEN FORMS AS WELL AS WRITTEN ONES. This table held "oz" and "lb"
     and not "ounce" or "pound", which is fine for something typed and
     wrong for everything said out loud: no transcriber writes "16 oz",
     they write "16 ounce". So "16 ounce New York steak" lost its weight
     entirely -- "ounce" stayed in the food's NAME, the quantity had
     nothing to attach to, and a sixteen-ounce steak was logged as one
     serving. The same held for pounds, kilograms, millilitres and the
     American spellings of litre. */
  "unitG": {
    "g": 1,
    "gram": 1,
    "grams": 1,
